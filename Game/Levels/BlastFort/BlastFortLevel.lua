...
function BlastFortLevel:load()
    ...
    BlastFortLevel.towerFrontStatefulObject:setInterpolation(InterpolationEnum.InterpolationTypeEnum.Linear, InterpolationEnum.InterpolationDirection.InOut, 1, 1)
    ...
    BlastFortLevel.towerBackStatefulObject:setInterpolation(InterpolationEnum.InterpolationTypeEnum.Linear, InterpolationEnum.InterpolationDirection.InOut, 1, 1)
